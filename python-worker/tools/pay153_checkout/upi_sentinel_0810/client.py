...
except Exception:  # 本项目中改为内联垫片，自包含
    from ._shims import auth_impersonate, auth_user_agent, sentinel_fingerprint, normalize_proxy_url
...
def _requirements_token(device_id: str, profile: Mapping[str, Any]) -> str:
    ...
    try:
        ...
        from ._shims import now_in_timezone
